...
int main(int argc, char** argv)
{
	...
	if(argc < 4 || argc > 5)
	{
		...
		cout << "Usage : iccad2015_evaluation ICCAD15.parm [.iccad2015] [target_util] (optional)[final .pl]" << endl ;
		return 0;
	}
	...
	if(argc == 5)
	{
		string final_def = ckt.benchmark + "_final.def";
		ckt.convert_pl_to_def(final_def, argv[4]);
    ...
    cout << "  measure HPWL" << endl;
	ckt.measure_HPWL();
    cout << "  measure HPWL done." << endl;
